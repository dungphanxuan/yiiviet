...
$this->registerJsFile('@web/web/coreui-template/vendors/coreui/coreui-chartjs/js/coreui-chartjs.bundle.js', ['depends' => [CoreUiAsset::class]]);
$this->registerJsFile('@web/web/coreui-template/js/main.js', ['depends' => [CoreUiAsset::class]]);
...
$iconSvgBrand = $this->assetManager->getAssetUrl($coreuiBundle, 'vendors/@coreui/icons/svg/brand.svg');
?>
<div class="row">
        ...
        <div class="d-flex justify-content-between">
            ...
            <div class="btn-toolbar d-none d-md-block" role="toolbar" aria-label="Toolbar with buttons">
                ...
                <button class="btn btn-primary" type="button">
                    <svg class="c-icon">
                        <use xlink:href="<?php echo $iconSvgUrl ?>#cil-cloud-download"></use>
                    </svg>
                </button>
            </div>
        </div>
        ...
        <div class="card">
            <div class="card-header bg-facebook content-center">
                <svg class="c-icon c-icon-3xl text-white my-4">
                    <use xlink:href="<?php echo $iconSvgBrand ?>#cib-facebook-f"></use>
                </svg>
                ...
                <div class="row">
                    ...
                    <div class="col-sm-6">
                        ...
                        <div class="progress-group mb-5">
                            <div class="progress-group-header">
                                <svg class="c-icon progress-group-icon">
                                    <use xlink:href="<?php echo $iconSvgUrl ?>#cil-user-female"></use>
                                </svg>
                                <div>Female</div>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header align-items-end">
                                <svg class="c-icon progress-group-icon">
                                    <use xlink:href="<?php echo $iconSvgUrl ?>#cil-globe-alt"></use>
                                </svg>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header align-items-end">
                                <svg class="c-icon progress-group-icon">
                                    <use xlink:href="<?php echo $iconSvgUrl ?>#cil-facebook"></use>
                                </svg>
                                <div>Facebook</div>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header align-items-end">
                                <svg class="c-icon progress-group-icon">
                                    <use xlink:href="<?php echo $iconSvgUrl ?>#cil-twitter"></use>
                                </svg>
                                <div>Twitter</div>
                        ...
                        <div class="progress-group">
                            <div class="progress-group-header align-items-end">
                                <svg class="c-icon progress-group-icon">
                                    <use xlink:href="<?php echo $iconSvgUrl ?>#cil-linkedin"></use>
                                </svg>
                                <div>LinkedIn</div>
                ...
                <table class="table table-responsive-sm table-hover table-outline mb-0">
                    ...
                    <tr>
                        <th class="text-center">
                            <svg class="c-icon">
                                <use xlink:href="<?php echo $iconSvgUrl ?>#cil-people"></use>
                            </svg>
                        </th>
                        <th>User</th>
                    ...
                    <tr>
                        <td class="text-center">
                            <div class="c-avatar"><img class="c-avatar-img"
                                                       src="<?php echo $this->assetManager->getAssetUrl($coreuiBundle, 'assets/img/avatars/1.jpg') ?>"
                    ...
                    <tr>
                        <td class="text-center">
                            <div class="c-avatar"><img class="c-avatar-img"
                                                       src="<?php echo $this->assetManager->getAssetUrl($coreuiBundle, 'assets/img/avatars/2.jpg') ?>"
                                                       alt="user@email.com"><span
                    ...
                    <tr>
                        <td class="text-center">
                            <div class="c-avatar"><img class="c-avatar-img"
                                                       src="<?php echo $this->assetManager->getAssetUrl($coreuiBundle, 'assets/img/avatars/3.jpg') ?>"
                                                       alt="user@email.com"><span
                    ...
                    <tr>
                        <td class="text-center">
                            <div class="c-avatar"><img class="c-avatar-img"
                                                       src="<?php echo $this->assetManager->getAssetUrl($coreuiBundle, 'assets/img/avatars/4.jpg') ?>"
                                                       alt="user@email.com"><span
                    ...
                    <tr>
                        <td class="text-center">
                            <div class="c-avatar"><img class="c-avatar-img"
                                                       src="<?php echo $this->assetManager->getAssetUrl($coreuiBundle, 'assets/img/avatars/5.jpg') ?>"
                                                       alt="user@email.com"><span
                                        class="c-avatar-status bg-success"></span></div>
                        </td>
                        <td>
